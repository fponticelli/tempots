 ...
 * @public
 */
export const substringAfter = (value: string, searchFor: string): string => {
 ...
 * @public
 */
export const substringBefore = (value: string, searchFor: string): string => {
  const pos = value.indexOf(searchFor)
  if (pos < 0) return ''
 ...
 * @public
 */
export const canonicalizeNewlines = (value: string): string => {
 ...
 * @public
 */
export const textEndsWithCaseInsensitive = (
  s: string,
  end: string
): boolean => {
  return (
 ...
 * @public
 */
export const textStartsWithCaseInsensitive = (
  s: string,
  start: string
): boolean => s.substring(0, start.length).toLowerCase() === start.toLowerCase()
 ...
 * @public
 */
export const textEndsWithAnyCaseInsensitive = (
  s: string,
  values: string[]
): boolean =>
  stringEndsWithAny(
 ...
 * @public
 */
export const textStartsWithAnyCaseInsensitive = (
  s: string,
  values: string[]
): boolean =>
  stringStartsWithAny(
 ...
 * @public
 */
export const textContainsCaseInsensitive = (
  s: string,
  test: string
): boolean => {
 ...
 * @public
 */
export const countStringOccurrences = (s: string, test: string): number => {
 ...
 *
 */
export const stringsDifferAtIndex = (a: string, b: string): number => {
  if (a === b) return -1
 ...
 * @public
 */
export const ellipsis = (s: string, maxlen = 20, symbol = '…'): string => {
  const sl = s.length
 ...
 * @public
 */
export const stringHashCode = (value: string, seed = 0x811c9dc5): number => {
  let hval = seed
 ...
 * @public
 */
export const stringHasContent = (value: string): boolean => {
 ...
 * @public
 */
export const isBreakingWhitespace = (value: string): boolean => {
 ...
 * @public
 */
export const ifEmptyString = (value: string, alt: string): string => {
 ...
 * @public
 */
export const randomStringSequence = (
  alphabet: string,
  length: number
): string => {
 ...
 * @public
 */
export const randomStringSequenceBase64 = (length: number): string => {
 ...
 * @public
 */
export const trimStringSlice = (
  value: string,
  index: number,
  length: number
): string => value.substring(0, index) + value.substring(index + length)
 ...
 * @public
 */
export const deleteFirstFromString = (
  value: string,
  toremove: string
): string => {
 ...
 * @public
 */
export const smartQuote = (s: string, prefer = "'"): string => {
  if (prefer === "'") {
 ...
 * @public
 */
export const jsQuote = (s: string, prefer = "'"): string => {
  if (s.indexOf('\n') >= 0) {
    return quote(s, '`')
  } else {
 ...
 * @public
 */
export const textToLines = (s: string): string[] => {
 ...
 * @public
 */
export const trimChars = (value: string, charlist: string): string => {
 ...
 * @public
 */
export const underscore = (s: string): string => {
  s = s.replace(/::/g, '/')
 ...
 * @public
 */
export const isSpaceAt = (s: string, pos: number): boolean => {
 ...
 * @public
 */
export const splitStringOnLast = (
  s: string,
  find: string
): [string] | [string, string] => {
 ...
 * @public
 */
export const splitStringOnFirst = (
  s: string,
  find: string
): [string] | [string, string] => {
