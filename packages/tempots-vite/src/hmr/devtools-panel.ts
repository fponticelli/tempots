...
(function() {
  ...
  style.textContent = [
    ...
    '.signal-name { color: #ccc; white-space: nowrap; flex-shrink: 0; }',
    '.signal-value { margin-left: auto; color: #a0d0a0; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; cursor: pointer; padding: 1px 4px; border-radius: 2px; min-width: 0; }',
